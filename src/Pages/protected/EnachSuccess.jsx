  ...
  return (
    <div className="flex items-center justify-center rounded-xl border-t-4 border-t-green-500">
      <div className="bg-white py-12 px-4 rounded-xl shadow-lg text-center w-full">
        <h1 className="text-xl font-bold mb-4">{transactinType === "ENACH" ? "eNACH Registration Successful 🎉" : "Transaction Successful 🎉"}</h1>

        <div className="text-sm mb-2 m-auto max-md:w-full py-3">
            <p className="mb-1"><span className="font-semibold">Transaction id:</span> <span>{transactionId || "Null"}</span></p>
        ...
        <p className="mb-2">Your mandate has been registered successfully.</p>
        :
        <>
